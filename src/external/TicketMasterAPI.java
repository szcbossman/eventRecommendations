...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "4HmH6GtAoLUCQs8vLmnN9RJb4u0uOGw3";
	
	@Override
	public List<Item> search(double lat, double lon, String term) { //originally return JSON array of objects
		...
		try {
			...
			//return events;
			return getItemList(events); //debug not using JSON but using own Item's fields
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
